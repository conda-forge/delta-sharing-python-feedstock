...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/delta-sharing-python-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14552&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/delta-sharing-python-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `delta-sharing-python` can be installed with:

```
conda install delta-sharing-python
```

It is possible to list all of the versions of `delta-sharing-python` available on your platform with:
